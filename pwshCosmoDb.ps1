function Invoke-CosmoDBRequest {
    param (
        $EndPoint,
        $DatabaseId,
        $CollectionId,
...
##example GET request
$result = Invoke-CosmoDBRequest-Method GET -EndPoint $EndPoint  -DatabaseId $DatabaseId -CollectionId $CollectionId -DatabaseSigningKey $DatabaseSigningKey
